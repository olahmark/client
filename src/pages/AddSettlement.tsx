  ...
  return (
    <Flex  bg="gray.20" align="top" justify="center" h="100vh">
        <Stack spacing={3} mx={'auto'} maxW={'lg'} py={12} px={6}>
          <Stack align={'center'}>
              <Heading fontSize={'3xl'}>Data of settlement</Heading>
          </Stack>
          <Box boxShadow='dark-lg' bg="white" p={6} rounded="md">
            <form onSubmit={handleSubmit}>
              <VStack spacing={0.5} align="flex-start">
                <FormControl>
                  <FormLabel htmlFor="settlement_name">Name</FormLabel>
                  <Input
                    bgColor = "gray.50"
                    id="settlement_name"
                ...
                <FormControl>
                  <FormLabel htmlFor="settlement_type">Settlement type</FormLabel>
                  <Input
                    bgColor = "gray.50"
                    id="settlement_type"
